...
const userSchema = new Schema<IUser>(
  {
    ...
    socialLinks: {
      ...
      facebook: {
        ...
        maxlength: [
          100,
          'Facebook profile url must be at least 100 characters long',
        ],
      },
      instagram: {
        type: String,
        maxlength: [
          100,
          'Instagram profile url must be at least 100 characters long',
        ],
      },
      linkedIn: {
        type: String,
        maxlength: [
          100,
          'LinkedIn profile url must be at least 100 characters long',
        ],
      },
      x: {
        type: String,
      ...
      youtube: {
        ...
        maxlength: [
          100,
          'Youtube channel url must be at least 100 characters long',
        ],
      },
    },
  },
